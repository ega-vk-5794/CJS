...
*   the licence picker at index 0, STP2 Lease Details at index 1.
  constants C_STEP_LEASE type I value 1 ##NO_TEXT.
  ...
  constants C_PERMIT_NO type STRING value 'PERMIT_NUMBER' ##NO_TEXT.
  constants C_PERMIT_DETAIL type STRING value 'PERMIT_DETAIL' ##NO_TEXT.
    ...
    LOOP AT ct_tables ASSIGNING FIELD-SYMBOL(<t>) WHERE ui_table_name = 'LICENSES' AND ui_table_column1 = lv_sel..
      IF <t>-ui_table_column1 = lv_sel.
        <t>-ui_table_column29 = 'S'.
         io_ctx->set_val( iv_name = 'LICENCE_NO_1'     iv_value = CONV #( <t>-UI_TABLE_COLUMN1 ) ).
      ENDIF.
    ENDLOOP.
  endmethod.
