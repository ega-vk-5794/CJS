...
*     and declared after this one in some variants.
        ...
        *
        *     REVERTED ONCE BY A STAGE-WITHOUT-PULL (b7344b0) and restored. It will go
        *     again on the next full stage unless SAP has pulled this class first -
        *     staging pushes SAP's copy over git, so an object newer in git than in SAP
        *     loses. Pull ZCL_RAK_JOURNEY_CSS before the next stage.
