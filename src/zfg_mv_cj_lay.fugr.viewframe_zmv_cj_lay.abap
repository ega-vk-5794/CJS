*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_CJ_LAY
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_CJ_LAY          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_CJ_LAY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_CJ_LAY_EXTRACT
TOTAL = ZMV_CJ_LAY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_CJ_LAY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_CJ_LAY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_CJ_LAY_EXTRACT
TOTAL = ZMV_CJ_LAY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_CJ_LAY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_CJ_LAY'
...
TOTAL = ZMV_CJ_LAY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_CJ_LAY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_CJ_LAY-UPD_FLAG NE SPACE.
